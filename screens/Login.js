          ...
          >
            ...
            <TouchableOpacity 
              ...
              onPress={() => {
                ...
                // Try with reset to ensure no navigation conflicts
                navigation.reset({
                  index: 0,
            ...
            >
              <Text style={styles.buttonText}>TEST REGISTER NAVIGATION</Text>
            </TouchableOpacity> */}
            ...
            <View style={styles.signupContainer}>
              ...
              <TouchableOpacity 
                onPress={() => {
                  console.log("Navigation attempt to Register");
                  ...
                  try {
                    ...
                    try {
                      // Try parent navigation if nested
                      navigation.dangerouslyGetParent()?.navigate('Register');
                    } catch (e2) {
                      console.log("Parent navigation failed:", e2);
                    }
                  }
                }}
              >
