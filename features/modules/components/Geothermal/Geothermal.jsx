...
const GeothermalEnergy = () => {
  ...
  // Use our unified hook with 'geothermal' as the energy type
  const {
    generationData,
    currentProjection,
    loading,
      ...
      >
        ...
        <View style={styles.headerContainer}>
          <View style={styles.titleRow}>
            ...
            <Text style={styles.headerTitle}>Geothermal Energy</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={[styles.generationValue, { color: "#FF6B6B" }]}>
